<template>
  <el-card shadow="never" class="border-0">
    ...
    <el-table :data="tableData" stripe style="width: 100%" v-loading="loading" default-expand-all>
              ...
              <template v-else>
                <div class="mt-3 bg-gray-100 p-3 rounded" v-for="(item, index) in row.extra" :key="index">
                  <h6 class="flex font-bold">
                    客服
                    <el-button type="primary" size="small" class="ml-auto" @click="openTextarea(row,item.data)">修改
                    </el-button>
                  </h6>
                  <p>
                    {{ item.data }}
      ...
      <el-table-column label="ID" width="55" align="center" prop="id"></el-table-column>
